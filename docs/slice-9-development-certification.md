...
| Immutable citations | The bounded audit passed 497 citations across 94 current and immediately preceding publication versions. It rehashed stored source text and checked exact excerpt offsets. Of those citations, 222 use their historical normalization coordinate system. The audit changed no source, citation, or publication. A final audit follows the remaining canary publications. |
