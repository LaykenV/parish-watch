...
- **Last updated:** 2026-08-31T11:33:59Z
...
The next reviews caught three related edge cases. Corpus scope identity dropped
...
before returning the incoming draft to its in-memory scope handoff. Opening a
recent conversation now updates the public route to the conversation's scope
instead of leaving the URL on the previous evidence scope.
