...
export const civicEvent = v.union(browserCivicEvent, v.literal('ask_submitted'), v.literal('ask_answered'), v.literal('ask_not_found'), v.literal('report_submitted'), v.literal('notification_sent'), v.literal('notification_failed'), v.literal('follow_created'), v.literal('coverage_requested'))
